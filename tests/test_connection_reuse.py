...
class TestConnectionReuse:
    ...
    def test_multiple_requests_with_reuse_enabled(self, cycle_with_reuse):
        ...
        # Make multiple requests to a reliable host - using httpbin instead of tlsfingerprint.com
    ...
    def test_mixed_reuse_settings(self, cycle_with_reuse):
        ...
        # Use httpbin for more reliable testing (tlsfingerprint.com can EOF under load)
